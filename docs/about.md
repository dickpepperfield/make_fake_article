...
This site participates in a webring, you can find more sites [here](https://webring.xxiivv.com), and read join it [here](https://github.com/XXIIVV/webring#join-the-webring)

[Go to the next site in the ring](https://webring.xxiivv.com)

[Go to the previous site in the ring](https://webring.xxiivv.com/#colindrake)
